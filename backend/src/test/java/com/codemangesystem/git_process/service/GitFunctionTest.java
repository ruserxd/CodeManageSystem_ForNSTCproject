...
class GitFunctionTest {
    @Test
    @DisplayName("測試 GitFunction 不能實體化")
    void noConstructionTest() {
        UnsupportedOperationException exception = assertThrows(UnsupportedOperationException.class, GitFunction::new);
