...
public class ApiController {
  ...
  public ApiController(GitCloner gitCloner, DataBaseService dataBaseService,
      UserService userService, GitPuller gitPuller) {
   ...
   */
  @PostMapping("/getData")
  public ResponseEntity<Project> getFileDataByProjectName(
